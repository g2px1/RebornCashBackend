package com.client.eurekaclient.utilities.unit;
...
public class Unit {
    ...
    public static JSONObject sendUnitTransaction(String to, String from, double amount) {
        ...
        return Unit.sendRequest(Unit.UNIT, new HashMap<>(Map.of("instruction", "i_push_transaction", "data", data)));
    }
    ...
    public static JSONObject getBalance(String name) {
        ...
        data.put("name", name);
        return Unit.sendRequest(Unit.UNIT, new HashMap<>(Map.of("instruction", "i_balance", "data", data)));
    }
    public static JSONObject findTransaction(String hash) {
        HashMap<String, Object> data = new HashMap<>();
        data.put("hash", hash);
        return Unit.sendRequest(Unit.UNIT, new HashMap<>(Map.of("instruction", "i_tx", "data", data)));
    }
    public static JSONObject blockHeight() {
        return Unit.sendRequest(Unit.UNIT, new HashMap<>(Map.of("instruction", "i_block_height")));
    }
    public static JSONObject poolSize() {
        return Unit.sendRequest(Unit.UNIT, new HashMap<>(Map.of("instruction", "i_pool_size")));
    }
}