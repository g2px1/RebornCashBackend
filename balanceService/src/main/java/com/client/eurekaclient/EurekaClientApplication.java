...
public class EurekaClientApplication {
    public static void main(String[] args) throws IOException {
        ...
        Optional<TransactionReceipt> transReceipt = gasProvider.getWeb3j().ethGetTransactionReceipt("0x111784e99f6ffed7b5ac11a3a81438df6daeee1f52c2dffd257ede6a2e53f91f").send().getTransactionReceipt();
