...
public class Trap {
    ...
    public Trap(String name, String trapId, String image, int cells, long created, long activeAfter, String optionType, String tool, long strikePrice, int cellsAvailable, String tokenName, double tokenTotalWeight, double tokenPerCell, String optionName, boolean status, long activeTill, int quantityOfLots) {
        this.name = name;
        this.trapId = trapId;
        this.image = image;
        this.cells = cells;
    ...
    public void updateFromRequest(TrapRequest trapRequest) {
        this.activeAfter = trapRequest.activeAfter;
        this.cells = trapRequest.cells;
        this.cellsAvailable = trapRequest.cellsAvailable;
        this.created = trapRequest.created;
//        this.image = trapRequest.imageFile.getOriginalFilename();
        this.name = trapRequest.name;
        this.optionType = trapRequest.optionType;
        this.strikePrice = Math.round(trapRequest.strikePrice);
        this.tokenTotalWeight = trapRequest.tokenTotalWeight;
        this.tool = trapRequest.tools;
//        this.tokenPerCell = trapRequest.meatPerCell;
    }
}
