package com.client.eurekaclient.models.response.mine;
...
public class TrapResponse {
    ...
    public static TrapResponse build(Mine mine) {
        return new TrapResponse(mine.name, mine.trapId, mine.image, mine.cells, mine.created, mine.activeAfter, mine.activeTill, mine.tool, mine.cellsAvailable, mine.tokenName, mine.tokenTotalWeight, mine.tokenPerCell, mine.quantityOfLots, mine.status);
    }
}
