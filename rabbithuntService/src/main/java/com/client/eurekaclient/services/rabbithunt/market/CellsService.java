package com.client.eurekaclient.services.rabbithunt.market;
...
public class CellsService {
    ...
    public ResponseEntity<Object> sellCells(SellCellsRequest sellCellsRequest, String username) throws Exception {
    ...
    public ResponseEntity<Object> buyCellsPack(BuyCellsPacks buyCellsPacks, String username) throws Exception {
